...
class HelperDB(
    ...
    fun deletarContato(id: Int){
        ...
        //Maneira 1 de fazer o DELETE
        //val where = "id = ?"
        //val arg = arrayOf("$id")
        //db.delete(TABLE_NAME,where,arg)

        //Maneira 2 de fazer o DELETE
